...
import { loginWithGoogle, signup } from "../../api/userApi";
      ...
      <div className="w-full max-w-[400px] bg-white px-8 py-12 shadow-sm sm:px-12">
        ...
        <form className="space-y-5" onSubmit={handleSubmit} noValidate>
          ...
          <div className="flex items-center gap-3 py-1">
            ...
            <span className="text-xs text-[#98a2b3]">또는</span>
          ...
          <button
            ...
            className="flex h-12 w-full items-center justify-center gap-3 rounded-md border border-[#d0d5dd] bg-white text-sm font-semibold text-[#344054] transition hover:bg-[#f9fafb]"
          >
            <GoogleIcon />
            Google로 계속하기
          </button>
